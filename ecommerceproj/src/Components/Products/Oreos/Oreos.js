                ...
                <div className='product-body'>
                    <div className='product-info'>
                        <div className='product-description'>
                            ...
                            <p>
                                Lucy’s Chocolate Dipped Oreos are America’s favorite cookie smothered in special milk chocolate.
...
export default connect(mapStateToProps, {addToCart, updateUser, getCartItem}) (Oreos);